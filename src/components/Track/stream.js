...
const Duration = ({ duration, isActive }) => {
    ...
    return (
        <div className={trackClass}>
            <div className='track-artwork'>
                <ArtworkAction action={() => onActiveTrack(activity.id)} className={playClass} isVisible={isVisible}>
            ...
            <div className='track-content'>
                <div className='track-content-header'>
                    ...
                    <div>
                        <Duration duration={duration} isActive={activeDurationFilterType !== filterTypes.ALL} />/{fromNow(created_at)}
                    </div>
                </div>
                <div className='track-content-footer'>
                    ...
                    <div className='track-content-footer-action'>
...
TrackStream.propTypes={
    ...
    onActiveTrack:React.PropTypes.func
}
